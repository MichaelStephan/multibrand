...
import de.bsh.constants.BshmultibrandcontrollercommonConstants;



/**
 * This is the extension manager of the Bshmultibrandcontrollercommon extension.
 */
public class BshmultibrandcontrollercommonManager extends GeneratedBshmultibrandcontrollercommonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(BshmultibrandcontrollercommonManager.class.getName());
	 ...
	 */
	public static BshmultibrandcontrollercommonManager getInstance()
	{
		return (BshmultibrandcontrollercommonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				BshmultibrandcontrollercommonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BshmultibrandcontrollercommonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of BshmultibrandcontrollercommonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of BshmultibrandcontrollercommonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of BshmultibrandcontrollercommonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
