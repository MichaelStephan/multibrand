...
import de.bsh.constants.BrandwebConstants;



/**
 * This is the extension manager of the Brandweb extension.
 */
public class BrandwebManager extends GeneratedBrandwebManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(BrandwebManager.class.getName());
	 ...
	 */
	public static BrandwebManager getInstance()
	{
		return (BrandwebManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				BrandwebConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BrandwebManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of BrandwebManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of BrandwebManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of BrandwebManager called, current tenant: " + getTenant().getTenantID());
		}
	}
