...
import de.bsh.constants.BshmultibrandwebcommonConstants;



/**
 * This is the extension manager of the Bshmultibrandwebcommon extension.
 */
public class BshmultibrandwebcommonManager extends GeneratedBshmultibrandwebcommonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(BshmultibrandwebcommonManager.class.getName());
	 ...
	 */
	public static BshmultibrandwebcommonManager getInstance()
	{
		return (BshmultibrandwebcommonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				BshmultibrandwebcommonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BshmultibrandwebcommonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of BshmultibrandwebcommonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of BshmultibrandwebcommonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of BshmultibrandwebcommonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
